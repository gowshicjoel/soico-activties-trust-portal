			...
			<div class="row justify-content-center">
				<div class="col-lg-6">
					<div class="section-title">
						<h2><p>Upcoming</p> <span>Blood Donating 
							Programs</span></h2>
					</div>
				</div>
			</div>
						...
						<div class="row align-items-center">
							...
							<div class="col-lg-6 col-md-6">
								<div class="content_wrapper">
									<h3 class="title">
										<a href="event-details.html">Periyaar Blood Donation Event</a>
									</h3>
									<p>
										Donate Your Blood to Save Others
									</p>
					...
					<div class="single_upcoming_event">
						<div class="row align-items-center">
							...
							<div class="col-lg-6 col-md-6">
								<div class="content_wrapper">
									<h3 class="title">
										<a href="event-details.html">Gandhi Blood Donation Event</a>
									</h3>
									<p>
										Donate Blood
									</p>
					...
					<div class="single_upcoming_event">
						<div class="row align-items-center">
							...
							<div class="col-lg-6 col-md-6">
								<div class="content_wrapper">
									<h3 class="title">
										<a href="event-details.html">Blood Donation Event</a>
									</h3>
									<p>
									Save lives ,
									Donate Blood
					...
					<div class="single_upcoming_event">
						<div class="row align-items-center">
							...
							<div class="col-lg-6 col-md-6">
								<div class="content_wrapper">
									<h3 class="title">
										<a href="event-details.html">KG Blood Donating Program</a>
									</h3>
									<p>
										We Save Lives
									</p>
