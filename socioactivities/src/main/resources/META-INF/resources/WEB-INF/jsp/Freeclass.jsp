...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	...
	<link rel="stylesheet" href="themeicons.css">
	<link rel="stylesheet" href="bootstrap.css">
	<link rel="stylesheet" href="owlcarousel.css">
	<link rel="stylesheet" href="popup.css">
	<link rel="stylesheet" href="nineselect.css">
...
<header class="default-header">
	...
	<section class="banner-area relative">
		...
		<div class="container">
			<div class="row justify-content-lg-end align-items-center banner-content">
				<div class="col-lg-5">
					<h1 class="text-white">Free Class</h1>
					<p>A place where helps the people to study for Goverment Examination.</p>
				</div>
			</div>
		</div>
	</section>
	<section class="upcoming_event_area section-gap-top">
		<div class="container">
			<div>
	<button align="right" onclick="window.location.href ='file:///E:/Software/charilife/stud%20register/index.html'" class="btn btn--radius-2 btn--blue" type="studregister">Registration for Free Class </button>
</div>
	
			<div class="row justify-content-center">
				<div class="col-lg-6">
					<div class="section-title">
						<h2><span>Free Class</span></h2>
					</div>
				</div>
			</div>
		<div class="row">
						...
						<div class="row align-items-center">
							...
							<div class="col-lg-6 col-md-6">
								<div class="content_wrapper">
									<h3 class="title">
										<a href="event-details.html">IAS Academy</a>
									</h3>
									<p>
									 crosscut road ,gandhipuram, coimbatore.
									</p>
					...
					<div class="single_upcoming_event">
						<div class="row align-items-center">
							...
							<div class="col-lg-6 col-md-6">
								<div class="content_wrapper">
									<h3 class="title">
										<a href="event-details.html">Edutel Academy</a>
									</h3>
									<p>
										18/4D, 2nd St, Thirunagar, Vadapalani, chennai-600026
									</p>
					...
					<div class="single_upcoming_event">
						<div class="row align-items-center">
							...
							<div class="col-lg-6 col-md-6">
								<div class="content_wrapper">
									<h3 class="title">
										<a href="event-details.html">Speed Institue</a>
									</h3>
									<p>
									No.527 Poonamalle High Road, Arumbakkam, Chennai - 600106
									</p>
					...
					<div class="single_upcoming_event">
						<div class="row align-items-center">
							...
							<div class="col-lg-6 col-md-6">
								<div class="content_wrapper">
									<h3 class="title">
										<a href="event-details.html">De Arc Academy</a>
									</h3>
									<p>
										LTL Building, 133/5, Avinash Road, ESSO Bunk, Peelamedu, Coimbatore
									</p>
					...
					<div class="offset-lg-1 col-lg-3 col-md-6 col-sm-6">
						<div class="single-footer-widget tp_widgets">
							...
							<div class="ml-5">
								...
								<p>KGiSL IIM, Saravanampatti, Coimbatore.</p>
